...
<form action="http://localhost/mvc/Category/updateCat" method="post">
	<table>
		...
		<tr>
			<td>Category Name</td>
			<td><input type="text" name="catName" required="1" value="<?php echo $value['catName'] ?>"></td>
		</tr>
		<tr>
			<td>Category Title</td>
			<td><input type="text" name="catTitle" required="1" value="<?php echo $value['catTitle'] ?>"></td>
		</tr>
		<tr>
			<td></td>
